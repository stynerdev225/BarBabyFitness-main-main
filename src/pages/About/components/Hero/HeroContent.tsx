...
export const HeroContent = () => {
  const words = ["DEDICATION", "PASSION", "RESULTS"];
  ...
  return (
    ...
    >
      ...
      <p className="text-2xl md:text-3xl text-gray-300 mb-8">
        From street workouts to global movement. We're not just building bodies
        – we're creating legends. Welcome to the revolution.
      </p>
